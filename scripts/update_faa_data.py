...
Downloads the latest FAA Digital Obstacle File (DOF) and Part 77 regional data,
converts it to match the current datafile.csv format used by the crane viewer application.

Note: NOTAM data is now fetched on-demand via Cloudflare Worker proxy (see cloudflare-worker/).
"""
